...
export const Editmascota = (props) => {
    const { xid } = props;
...
//window.alert(id_mascota)  
const respuesta = await axios.get(`https://buddy-care-rest-api.onrender.com/mascotas/${id_mascota}`)
    //window.alert("datos cargados")
    
   
    setDatos(respuesta.data);

    activarModificacion(id_mascota)
  } catch (error) { 
...
<div style={{
        ...
        <div className='col-12'>
                  <h3 className='text-center'>Editar Mascota</h3>    
                  <form >
